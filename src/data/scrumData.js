export const terms = [
  { id: 1, term: 'スプリント（Sprint）', definition: '開発の基本サイクル。通常1〜4週間の固定期間で、計画→実行→レビュー→振り返りを繰り返す。', color: 'purple' },
  { id: 2, term: 'プロダクトバックログ', definition: 'プロダクトに必要な機能・改善・バグ修正をすべてリスト化したもの。POが優先順位をつけて管理する。', color: 'blue' },
  { id: 3, term: 'スプリントバックログ', definition: '1スプリントで実施するタスクの一覧。スプリント計画ミーティングでチームが選択する。', color: 'teal' },
  { id: 4, term: 'デイリースクラム（Daily Scrum）', definition: '毎朝15分以内の立ちミーティング。昨日やったこと・今日やること・障害の3点を共有する。', color: 'green' },
  { id: 5, term: 'スプリントレビュー', definition: 'スプリント終了時にステークホルダーに成果物をデモし、フィードバックをもらう会議。', color: 'yellow' },
  { id: 6, term: 'スプリントレトロスペクティブ', definition: 'スプリントの進め方を振り返り、次スプリントの改善点を決める内部ミーティング。', color: 'orange' },
  { id: 7, term: 'ベロシティ（Velocity）', definition: '1スプリントでチームが完了できる作業量の指標。ストーリーポイントで測定する。', color: 'red' },
  { id: 8, term: 'ユーザーストーリー', definition: '「〇〇として、△△したい。なぜなら□□だから」の形式でユーザー視点の要求を記述したもの。', color: 'pink' },
  { id: 9, term: 'ストーリーポイント', definition: 'タスクの複雑さ・不確実性・工数を相対的に見積もる単位。時間ではなく相対値を使う。', color: 'purple' },
  { id: 10, term: 'Definition of Done（DoD）', definition: '「完了」と見なすための合意基準。コードレビュー・テスト通過・デプロイ完了など具体的に定義する。', color: 'blue' },
  { id: 11, term: 'インクリメント', definition: 'スプリント終了時に得られる、動作する成果物の積み上げ。リリース可能な状態であることが望ましい。', color: 'teal' },
  { id: 12, term: 'スクラムボード', definition: 'Todo・In Progress・Doneなどのカラムでタスク状況を可視化するボード。JiraやNotionで管理。', color: 'green' },
  { id: 13, term: 'バーンダウンチャート', definition: 'スプリント内の残作業量を日々グラフ化したもの。進捗の遅れを早期に発見するために使う。', color: 'yellow' },
]
